        ...
        <div className='container'>
          ...
          <div>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7'>
              ...
              {['Basic', 'Professional'].map((planName, planIdx) => {
                const price = planIdx === 0 ? tabConfig.basicPrice : tabConfig.professionalPrice
                const features = [
                  'Monthly service fee',
                  'Direct debits',
                  'Online payments',
                  'Deposits to Savers',
                  planIdx === 0 ? 'International transaction fees' : null,
                ].filter(Boolean)
                    ...
                    <div className='flex grow flex-col p-6 sm:p-8'>
                      ...
                      <ul className='flex flex-col grow gap-5 pt-6'>
                        {features.map((feature, featIdx) => (
                          <li key={featIdx} className='flex items-center gap-5'>
                            <svg
                              width='25'
                              height='25'
                              viewBox='0 0 25 25'
                              ...
                              <g clipPath='url(#clip0_7_836)'>
                                {featIdx === features.length - 1 && planIdx === 0 ? (
                                  <path
