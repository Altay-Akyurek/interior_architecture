...
const FaqQuestion = () => {
  ...
  return (
    <>
      <section className='bg-white dark:bg-darkmode pt-40 pb-20'>
        <div className='container'>
          <div>
            <div className='flex flex-col gap-y-8'>
              ...
              <div className='overflow-hidden relative z-10 lg:w-770 w-full m-auto bg-white rounded-2xl shadow-light_shadwo dark:shadow-none dark:border dark:border-solid dark:border-dark_border'>
                ...
                <div className='accordion__item accordion__item--static text-center bg-AliceBlue dark:bg-darkmode py-8'>
