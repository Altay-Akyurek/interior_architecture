...
const BuildAmazing = ({ isSpace }: { isSpace: boolean }) => {
  return (
    <>
      <section className={`${isSpace ? '' : ''} bg-white dark:bg-darkmode pt-40 pb-20`}>
          ...
          <div className='grid lg:grid-cols-2 grid-cols-1 items-center'>
            <div
              ...
              <h2 className='text-secondary dark:text-white max-w-420 pb-8'>
                İç Mekânlarınızı Hayalinizdeki Gibi Tasarlıyoruz
              </h2>
              <p className='text-base font-normal text-SlateBlue dark:text-darktext max-w-408'>
                Her projede fonksiyonellik ve estetiği bir araya getirerek, 
                yaşam alanlarınızı dönüştürüyoruz.
              </p>
              <div className='pt-6 flex flex-col gap-y-5'>
                {['Özel Tasarım Çözümleri', '3D Görselleştirme', 'Uygulama Hizmeti'].map((item, idx) => (
